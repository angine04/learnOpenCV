...
int main()
{
    ...
    // initUndistortRectifyMap(cameraMatrix, distCoeffs, Mat(),getOptimalNewCameraMatrix(cameraMatrix, distCoeffs, frameCalibration_Size, 0.5, frameCalibration_Size, 0),frameCalibration_Size, CV_16SC2, map1, map2);
...
//        GaussianBlur(gray, gray, Size(9, 9), 2, 2);
        ...
        int min_r = 40;
        int max_r = 200;
        HoughCircles(gray, circles, HOUGH_GRADIENT_ALT, 1.5, mindist, 95, 0.92, min_r, max_r);
